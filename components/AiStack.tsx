                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
                    {tools.map((tool, i) => (
                        <RevealWrapper key={tool.name} delay={i * 0.1}>
                            <div className="bg-warm-white p-6 md:p-8 rounded-[20px] border border-bark/5 hover:border-clay hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(193,98,47,0.08)] transition-all duration-300 h-full flex flex-col justify-between items-center text-center group">
